...
def main():
    ...
    for epoch in range(0, 30):
        for subepoch in range(4):
            ...
            # Train
            model.fit(X, Y, batch_size=Hyperparams.batch_size, epochs=1)
            model.save_weights("../ckpt/exp-epoch-{}-{}.h5".format(epoch, subepoch))

        # Evaluation
        _model = build_model(Hyperparams.ctxlen)
